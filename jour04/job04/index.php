    ...
    <table border="1">
        ...
        <tbody>
            <tr>
                ...
                <td> <?php echo $prenom = isset($_POST['user_surrname']) ? $_POST['user_surrname'] : $prenom; ?> </td> <!--  recupère et affiche le prenoms, n'affiche rien si cela n'existe pas -->
            </tr>
        </tbody>
        <tbody>

            <td> <?php echo "Nom"; ?> </td>
            <td> <?php echo $nom = isset($_POST['user_name']) ? $_POST['user_name'] : $nom; ?> </td> <!--  recupère et affiche le nom, n'affiche rien si cela n'existe pas -->
        </tbody>
    </table>
